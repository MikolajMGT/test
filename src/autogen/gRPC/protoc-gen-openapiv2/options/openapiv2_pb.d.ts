...
export class Swagger extends jspb.Message {
  ...
  addSchemes(value: Scheme, index?: number): Swagger;
...
export class Operation extends jspb.Message {
  ...
  addSchemes(value: Scheme, index?: number): Operation;
...
export class JSONSchema extends jspb.Message {
  ...
  clearEnumList(): JSONSchema;
  addEnum(value: string, index?: number): JSONSchema;
  ...
  clearFieldConfiguration(): JSONSchema;

  getExtensionsMap(): jspb.Map<string, google_protobuf_struct_pb.Value>;
  clearExtensionsMap(): JSONSchema;
