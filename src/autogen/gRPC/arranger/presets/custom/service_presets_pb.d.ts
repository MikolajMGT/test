...
export class CreateRequest extends jspb.Message {
  getBaseId(): string;
  setBaseId(value: string): CreateRequest;
...
export class UpdateRequest extends jspb.Message {
  ...
  getOverride(): arranger_presets_models_pb.BlueprintOverrideValue | undefined;
  setOverride(value?: arranger_presets_models_pb.BlueprintOverrideValue): UpdateRequest;
  hasOverride(): boolean;
  clearOverride(): UpdateRequest;
...
export namespace UpdateRequest {
  export type AsObject = {
    ...
    override?: arranger_presets_models_pb.BlueprintOverrideValue.AsObject,
  }
}
